...
list.prototype.popAndPrepend = function(callback) {
    this._runCommand('brpoplpush', [this.listName, this.listName, 0], callback);
};
...
list.prototype._runCommand = function(command, args, callback) {
    this.client[command].apply(this.client, (typeof callback === "function")? args.concat(callback) : args);
}
